...
abstract class BaseEventI18n implements ArrayAccess
{
  const
    DATABASE_NAME = 'propel',

    TABLE_NAME = 'event_i18n',

    NAME = 'event_i18n.NAME',
    DESCRIPTION = 'event_i18n.DESCRIPTION',
    DATE = 'event_i18n.DATE',
    ID = 'event_i18n.ID',
    CULTURE = 'event_i18n.CULTURE';

  public static function addSelectColumns(Criteria $criteria)
  {
    $criteria->addSelectColumn(QubitEventI18n::NAME);
    $criteria->addSelectColumn(QubitEventI18n::DESCRIPTION);
    $criteria->addSelectColumn(QubitEventI18n::DATE);
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitEventI18n::DATABASE_NAME)->getTable(QubitEventI18n::TABLE_NAME);
  }
