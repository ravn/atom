...
abstract class BaseRelationI18n implements ArrayAccess
{
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitRelationI18n::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitRelationI18n', $options);
  }
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitRelationI18n::DATABASE_NAME)->getTable(QubitRelationI18n::TABLE_NAME);
  }
