...
abstract class BaseStatus implements ArrayAccess
{
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitStatus::DATABASE_NAME);
    }
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitStatus::DATABASE_NAME)->getTable(QubitStatus::TABLE_NAME);
  }
