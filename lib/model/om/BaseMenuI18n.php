...
abstract class BaseMenuI18n implements ArrayAccess
{
  const
    DATABASE_NAME = 'propel',

    TABLE_NAME = 'menu_i18n',

    LABEL = 'menu_i18n.LABEL',
    DESCRIPTION = 'menu_i18n.DESCRIPTION',
    ID = 'menu_i18n.ID',
    CULTURE = 'menu_i18n.CULTURE';

  public static function addSelectColumns(Criteria $criteria)
  {
    $criteria->addSelectColumn(QubitMenuI18n::LABEL);
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitMenuI18n::DATABASE_NAME)->getTable(QubitMenuI18n::TABLE_NAME);
  }
