...
abstract class BaseOaiHarvest implements ArrayAccess
{
  const
    DATABASE_NAME = 'propel',

    TABLE_NAME = 'oai_harvest',

    ID = 'oai_harvest.ID',
    OAI_REPOSITORY_ID = 'oai_harvest.OAI_REPOSITORY_ID',
    START_TIMESTAMP = 'oai_harvest.START_TIMESTAMP',
    END_TIMESTAMP = 'oai_harvest.END_TIMESTAMP',
    LAST_HARVEST = 'oai_harvest.LAST_HARVEST',
    LAST_HARVEST_ATTEMPT = 'oai_harvest.LAST_HARVEST_ATTEMPT',
    METADATAPREFIX = 'oai_harvest.METADATAPREFIX',
    SET = 'oai_harvest.SET',
    CREATED_AT = 'oai_harvest.CREATED_AT',
    SERIAL_NUMBER = 'oai_harvest.SERIAL_NUMBER';

  public static function addSelectColumns(Criteria $criteria)
  {
    $criteria->addSelectColumn(QubitOaiHarvest::ID);
    $criteria->addSelectColumn(QubitOaiHarvest::OAI_REPOSITORY_ID);
    $criteria->addSelectColumn(QubitOaiHarvest::START_TIMESTAMP);
    $criteria->addSelectColumn(QubitOaiHarvest::END_TIMESTAMP);
    $criteria->addSelectColumn(QubitOaiHarvest::LAST_HARVEST);
    $criteria->addSelectColumn(QubitOaiHarvest::LAST_HARVEST_ATTEMPT);
  ...
  public static function getById($id, array $options = array())
  {
    ...
    $criteria->add(QubitOaiHarvest::ID, $id);
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitOaiHarvest::DATABASE_NAME)->getTable(QubitOaiHarvest::TABLE_NAME);
  }
  ...
  public static function addJoinoaiRepositoryCriteria(Criteria $criteria)
  {
    $criteria->addJoin(QubitOaiHarvest::OAI_REPOSITORY_ID, QubitOaiRepository::ID);
