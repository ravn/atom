...
abstract class BaseSlug implements ArrayAccess
{
  const
    ...
    SLUG = 'slug.SLUG',
    ID = 'slug.ID',
    SERIAL_NUMBER = 'slug.SERIAL_NUMBER';

  public static function addSelectColumns(Criteria $criteria)
  {
    $criteria->addSelectColumn(QubitSlug::OBJECT_ID);
    $criteria->addSelectColumn(QubitSlug::SLUG);
    $criteria->addSelectColumn(QubitSlug::ID);
    $criteria->addSelectColumn(QubitSlug::SERIAL_NUMBER);
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitSlug::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitSlug', $options);
  }
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitSlug::DATABASE_NAME)->getTable(QubitSlug::TABLE_NAME);
  }
  ...
  protected function rowOffsetGet($name, $offset, $options)
  {
    ...
    if (!array_key_exists($offset, $this->row))
    {
      ...
      $criteria = new Criteria;
      $criteria->add(QubitSlug::ID, $this->id);
