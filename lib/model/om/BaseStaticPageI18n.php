...
abstract class BaseStaticPageI18n implements ArrayAccess
{
  const
  ...
  public static function getFromRow(array $row)
  {
    ...
    if (!isset(self::$staticPageI18ns[$key]))
    {
      ...
      $staticPageI18n->keys = $keys;
      $staticPageI18n->row = $row;

      $staticPageI18n->new = false;
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitStaticPageI18n::DATABASE_NAME)->getTable(QubitStaticPageI18n::TABLE_NAME);
  }
