...
abstract class BaseAclUserGroup implements ArrayAccess
{
  const
    DATABASE_NAME = 'propel',

    TABLE_NAME = 'acl_user_group',

    ID = 'acl_user_group.ID',
    USER_ID = 'acl_user_group.USER_ID',
    GROUP_ID = 'acl_user_group.GROUP_ID',
    SERIAL_NUMBER = 'acl_user_group.SERIAL_NUMBER';
  ...
  public static function addSelectColumns(Criteria $criteria)
  {
    ...
    $criteria->addSelectColumn(QubitAclUserGroup::SERIAL_NUMBER);
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitAclUserGroup::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitAclUserGroup', $options);
  }
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitAclUserGroup::DATABASE_NAME)->getTable(QubitAclUserGroup::TABLE_NAME);
  }
