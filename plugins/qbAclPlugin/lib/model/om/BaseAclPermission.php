...
abstract class BaseAclPermission implements ArrayAccess
{
  const
    ...
    ID = 'acl_permission.ID',
    USER_ID = 'acl_permission.USER_ID',
    GROUP_ID = 'acl_permission.GROUP_ID',
    OBJECT_ID = 'acl_permission.OBJECT_ID',
    ACTION = 'acl_permission.ACTION',
    GRANT_DENY = 'acl_permission.GRANT_DENY',
    CONDITIONAL = 'acl_permission.CONDITIONAL',
    CONSTANTS = 'acl_permission.CONSTANTS',
    CREATED_AT = 'acl_permission.CREATED_AT',
    UPDATED_AT = 'acl_permission.UPDATED_AT',
    SERIAL_NUMBER = 'acl_permission.SERIAL_NUMBER';
