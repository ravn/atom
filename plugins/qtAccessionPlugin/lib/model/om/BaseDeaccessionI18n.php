...
abstract class BaseDeaccessionI18n implements ArrayAccess
{
  const
  ...
  public static function getFromRow(array $row)
  {
    ...
    {
      $deaccessionI18n = new QubitDeaccessionI18n;

      $deaccessionI18n->keys = $keys;
      $deaccessionI18n->row = $row;

      $deaccessionI18n->new = false;

      self::$deaccessionI18ns[$key] = $deaccessionI18n;
    }

    return self::$deaccessionI18ns[$key];
  }

  public static function clearCache()
  {
    self::$deaccessionI18ns = array();
  }
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitDeaccessionI18n::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitDeaccessionI18n', $options);
  }
  ...
  public static function getByIdAndCulture($id, $culture, array $options = array())
  {
    ...
    $criteria->add(QubitDeaccessionI18n::CULTURE, $culture);
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitDeaccessionI18n::DATABASE_NAME)->getTable(QubitDeaccessionI18n::TABLE_NAME);
  }
  ...
  protected function rowOffsetGet($name, $offset, $options)
  {
    ...
    if (!array_key_exists($offset, $this->row))
    {
      ...
      $criteria = new Criteria;
      $criteria->add(QubitDeaccessionI18n::ID, $this->id);
      $criteria->add(QubitDeaccessionI18n::CULTURE, $this->culture);
  ...
  public static function addJoindeaccessionCriteria(Criteria $criteria)
  {
    $criteria->addJoin(QubitDeaccessionI18n::ID, QubitDeaccession::ID);
