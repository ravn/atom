...
abstract class BaseAccessionI18n implements ArrayAccess
{
  const
    ...
    SCOPE_AND_CONTENT = 'accession_i18n.SCOPE_AND_CONTENT',
  ...
  public static function addSelectColumns(Criteria $criteria)
  {
    ...
    $criteria->addSelectColumn(QubitAccessionI18n::SCOPE_AND_CONTENT);
  ...
  public static function getFromRow(array $row)
  {
    ...
    {
      $accessionI18n = new QubitAccessionI18n;

      $accessionI18n->keys = $keys;
      $accessionI18n->row = $row;

      $accessionI18n->new = false;

      self::$accessionI18ns[$key] = $accessionI18n;
    }

    return self::$accessionI18ns[$key];
  }

  public static function clearCache()
  {
    self::$accessionI18ns = array();
  }
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitAccessionI18n::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitAccessionI18n', $options);
  }
  ...
  public static function getByIdAndCulture($id, $culture, array $options = array())
  {
    ...
    $criteria->add(QubitAccessionI18n::CULTURE, $culture);
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitAccessionI18n::DATABASE_NAME)->getTable(QubitAccessionI18n::TABLE_NAME);
  }
  ...
  protected function rowOffsetGet($name, $offset, $options)
  {
    ...
    if (!array_key_exists($offset, $this->row))
    {
      ...
      $criteria = new Criteria;
      $criteria->add(QubitAccessionI18n::ID, $this->id);
      $criteria->add(QubitAccessionI18n::CULTURE, $this->culture);
  ...
  {
    $criteria->addJoin(QubitAccessionI18n::ID, QubitAccession::ID);
